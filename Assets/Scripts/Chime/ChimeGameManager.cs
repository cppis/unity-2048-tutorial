...
public class ChimeGameManager : MonoBehaviour
{
    public static ChimeGameManager Instance { get; private set; }

    [Header("References")]
    public ChimeGrid grid;
    public ChimeQuadDetector quadDetector;
    public ChimePulseSystem pulseSystem;
    public GameObject blockPrefab;

    [Header("Block Shapes")]
    public ChimeBlockShape[] blockShapes;
    ...
    private ChimeBlock currentBlock;
    private int score = 0;
    ...
    private void SpawnNewBlock()
    {
        ...
        currentBlock = blockObj.GetComponent<ChimeBlock>();
        ...
        {
            Debug.LogError("ChimeBlock component not found on blockPrefab!");
        }
    }
