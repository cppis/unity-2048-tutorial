...
public class ChimeGrid : MonoBehaviour
{
    ...
    private ChimeCell[,] cells = new ChimeCell[WIDTH, HEIGHT];
    ...
    private ChimeCell CreateCell(int x, int y)
    {
    ...
    public ChimeCell GetCell(int x, int y)
    {
    ...
    public ChimeCell GetCell(Vector2Int coords)
    {
